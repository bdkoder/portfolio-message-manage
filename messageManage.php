...
<html>
    <head>
        ...
        <title>View and Manage Message </title>
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="messageManage">Manage Contact</a></li>
            ...
            <div class="box-body">
              <table id="example1" class="table table-hover table-bordered table-striped">
                ...
                <tbody>
                   ...
                   <tr>
                  <td> <?php echo $i++;?></td>
                  <td> <?php echo $messageinfo['name']; ?></td>
...
<!--                  <td> <?php //echo $messageinfo['text']?></td>-->
                  ...
                  <td>
                      <a  href="messageViewById?title=<?php echo $messageinfo['name']?>&&id=<?php echo $messageinfo['id']?>"> <i class="fa fa-eye"> </i></a> || 
